var JJUSenateMapType = new MapType(
  "JJU-Senate",
  "Senate",
  "S",
  "assets/usa-senate.png",
  "svg-sources/jju-senate-map.svg",
  10,
  function()
  {
    return 1
  ...
  () => {
    // CSV: SVG,
	  const regionNameToID = {"North": "N1", "North Sitting": "N2", "East": "E1", "East Sitting": "E2", "South": "S1", "South Sitting": "S2", "West": "W1", "West Sitting": "W2", "Center": "C1", "Center Sitting": "C2", "National Popular Vote": nationalPopularVoteID}
     ...
     const getRegions = () => ['N1', 'N2', 'S1', 'S2', 'E1', 'E2', 'W1', 'W2', 'C1', 'C2']
      
// No fucking idea if this works, but okay, I guess -Javer
      const regionDateRanges = [
        {
          start: new Date(2025, 1-1, 1-1).getTime(),
          regions: [
            ...getRegions()
          ]
        }
    ...
    function getSenateSVGByDate(dateTime)
    {
      ...
      if (mapDate < new Date(2030, 10-1, 1)) //Ass fix but it works i think -Javer
      {
        return "svg-sources/jju-senate-map.svg"
      }
      else{}
    }
    ...
    // Todo: add the shit from the previous elections - Wiki - not the original shit - im not gonna do that not my job - Javer
	  ...
	  var PastElectionResultMapSource = new MapSource(
	    "JJU-Past-Senate-Elections", // id
	    "Past Elections", // name
	    "./csv-sources/jju-past-senate.csv", // dataURL
