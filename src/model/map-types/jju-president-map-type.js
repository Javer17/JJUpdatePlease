const JJUPresidentMapType = new MapType(
  ...
  () => {
    ...
    const electionDateToSpreadsheetData = {
      1724223600000: {
    ...
    const idsToPartyNames = {}
    const partyNamesToIDs = {}
    for (const partyNum in mainPoliticalPartyIDs)
    {
    ...
    const defaultPresidentCompareSourceIDs = {}
